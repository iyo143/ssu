...
Route::delete('/student/delete/{id}',[StudentController::class,'destroyStudent'])->name('student.delete');
...
Route::get('/admin-edit/document/{id}',[DocumentController::class,'editDocument'])->name('edit.document');
Route::put('/admin/document/update/{id}',[DocumentController::class,'update'])->name('update.document');
Route::get('/admin/document/detached/{id}/{doc}',[DocumentController::class,'detached'])->name('detached.requirement');
