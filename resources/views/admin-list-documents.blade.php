        ...
        <div class="main">
            ...
            @include('layouts.partials.side-bar')
                <div class="col-xl-8 col-md-8 col-sm-8">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-file"></i> {{ __('LIST OF DOCUMENTS') }}</div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                @foreach($documents as $document)
                                    <tr>
                                        ...
                                        <td><a href="{{route('edit.document', $document->id)}}"><button class="btn btn-success" type=""> Edit</button></a></td> 
