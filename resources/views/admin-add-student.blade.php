        ...
        <div class="main">
            ...
            @include('layouts.partials.side-bar')
                ...
                <div class="col-xl-8 col-md-7 col-sm-6">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-file-import"></i> {{ __(' IMPORT OF STUDENTS') }}</div>
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"><i class="fas fa-user-graduate"></i> {{ __('Add Student') }}</div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('student.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Student ID') }}</label>
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control @error('student_id') is-invalid @enderror" name="student_id" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                        @error('student_id')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="name" class="form-control @error('course') is-invalid @enderror" name="course" required autocomplete="name" autofocus aria-placeholder="open to select course">
                                            <option value="" selected>Open this to select course</option>
